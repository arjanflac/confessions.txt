...
export function createMcpServer() {
  ...
  server.registerTool(
    ...
    {
      title: "Resolve Public Artifact Reference",
      description:
    ...
    async ({ reference, check_artifact }) =>
      asTextResult(
        await resolveVerificationReference(reference, {
          checkArtifact: check_artifact !== false
        })
      )
  );
  ...
  server.registerTool(
    ...
    async (input) => asTextResult(generateLocalVerificationSteps(input))
  );
